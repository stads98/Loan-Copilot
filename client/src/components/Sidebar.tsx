  ...
  return (
    <aside className="bg-gradient-to-b from-blue-800 to-blue-900 text-white w-64 flex-shrink-0 hidden md:flex md:flex-col shadow-lg">
      <div className="p-5 border-b border-blue-700 bg-blue-800">
        <Link href="/dashboard">
          <a className="text-xl font-heading font-bold flex items-center cursor-pointer">
      ...
      <nav className="mt-6 px-3 flex-1">
        <div className="space-y-1">
          <Link href="/dashboard">
            <a className={`group flex items-center px-3 py-3 text-sm font-medium rounded-lg transition-all duration-200 ${
        ...
        <div className="pt-6 mt-6 border-t border-blue-700">
          ...
          <div className="space-y-1">
            <Link href="/loans/1">
              <a className={`flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors duration-200 ${
                location === "/loans/1" 
